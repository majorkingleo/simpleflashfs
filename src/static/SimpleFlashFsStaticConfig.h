...
#include "../base/SimpleFlashFsLock.h"
...
namespace SimpleFlashFs::static_memory {
    ...
    struct Config
    {
      ...
      // No-op mutex: the static configuration targets bare-metal /
      // single-threaded use, so any locking added inside
      // SimpleFlashFsBase compiles down to nothing here.
      using mutex_type = ::SimpleFlashFs::NullMutex;

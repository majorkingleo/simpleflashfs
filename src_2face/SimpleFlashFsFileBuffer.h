...
public:
	...
	bool seek( std::size_t pos_ ) override;
	 ...
	 // Truncate the file (and our buffered view) to `new_size`. Forwarded
	 // to the underlying FileInterface after flushing/discarding any
	 // buffered data that would otherwise overlap or extend past the new
	 // size.
